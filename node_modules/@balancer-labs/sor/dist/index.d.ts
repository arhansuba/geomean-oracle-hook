...
interface PoolDataService {
    getPools(query?: GraphQLArgs, chunkSize?: number): Promise<SubgraphPoolBase[]>;
}
...
declare class SOR {
     ...
     */
    fetchPools(queryArgs?: GraphQLArgs, chunkSize?: number): Promise<boolean>;
    /**
...
declare function safeParseFixed(value: string, decimals?: number): BigNumber$1;
...
declare type Gyro2PoolPairData = PoolPairBase & {
    sqrtAlpha: BigNumber$1;
    sqrtBeta: BigNumber$1;
};
declare type Gyro2PoolToken$1 = Pick<SubgraphToken, 'address' | 'balance' | 'decimals'>;
declare class Gyro2Pool implements PoolBase<Gyro2PoolPairData> {
    poolType: PoolTypes;
    id: string;
    address: string;
    tokensList: string[];
    tokens: Gyro2PoolToken$1[];
    swapFee: BigNumber$1;
    totalShares: BigNumber$1;
    sqrtAlpha: BigNumber$1;
    sqrtBeta: BigNumber$1;
    static fromPool(pool: SubgraphPoolBase): Gyro2Pool;
    constructor(id: string, address: string, swapFee: string, totalShares: string, tokens: Gyro2PoolToken$1[], tokensList: string[], sqrtAlpha: string, sqrtBeta: string);
    parsePoolPairData(tokenIn: string, tokenOut: string): Gyro2PoolPairData;
    getNormalizedLiquidity(poolPairData: Gyro2PoolPairData): BigNumber;
    getLimitAmountSwap(poolPairData: Gyro2PoolPairData, swapType: SwapTypes): BigNumber;
    updateTokenBalanceForPool(token: string, newBalance: BigNumber$1): void;
    updateTotalShares(newTotalShares: BigNumber$1): void;
    _exactTokenInForTokenOut(poolPairData: Gyro2PoolPairData, amount: BigNumber): BigNumber;
    _tokenInForExactTokenOut(poolPairData: Gyro2PoolPairData, amount: BigNumber): BigNumber;
    _calcTokensOutGivenExactBptIn(bptAmountIn: BigNumber$1): BigNumber$1[];
    _calcBptOutGivenExactTokensIn(amountsIn: BigNumber$1[]): BigNumber$1;
    _spotPriceAfterSwapExactTokenInForTokenOut(poolPairData: Gyro2PoolPairData, amount: BigNumber): BigNumber;
    _spotPriceAfterSwapTokenInForExactTokenOut(poolPairData: Gyro2PoolPairData, amount: BigNumber): BigNumber;
    _derivativeSpotPriceAfterSwapExactTokenInForTokenOut(poolPairData: Gyro2PoolPairData, amount: BigNumber): BigNumber;
    _derivativeSpotPriceAfterSwapTokenInForExactTokenOut(poolPairData: Gyro2PoolPairData, amount: BigNumber): BigNumber;
}

declare type Gyro2V2PoolPairData = PoolPairBase & {
    sqrtAlpha: BigNumber$1;
    sqrtBeta: BigNumber$1;
    tokenRates: BigNumber$1[];
};
declare type Gyro2PoolToken = Pick<SubgraphToken, 'address' | 'balance' | 'decimals'>;
declare class Gyro2V2Pool implements PoolBase<Gyro2V2PoolPairData> {
    poolType: PoolTypes;
    id: string;
    address: string;
    tokensList: string[];
    ...
    constructor(id: string, address: string, swapFee: string, totalShares: string, tokens: Gyro2PoolToken[], tokensList: string[], sqrtAlpha: string, sqrtBeta: string, tokenRates: string[]);
    parsePoolPairData(tokenIn: string, tokenOut: string): Gyro2V2PoolPairData;
    getNormalizedLiquidity(poolPairData: Gyro2V2PoolPairData): BigNumber;
    getLimitAmountSwap(poolPairData: Gyro2V2PoolPairData, swapType: SwapTypes): BigNumber;
    updateTokenBalanceForPool(token: string, newBalance: BigNumber$1): void;
    updateTotalShares(newTotalShares: BigNumber$1): void;
    _exactTokenInForTokenOut(poolPairData: Gyro2V2PoolPairData, amount: BigNumber): BigNumber;
    _tokenInForExactTokenOut(poolPairData: Gyro2V2PoolPairData, amount: BigNumber): BigNumber;
    _calcTokensOutGivenExactBptIn(bptAmountIn: BigNumber$1): BigNumber$1[];
    _calcBptOutGivenExactTokensIn(amountsIn: BigNumber$1[]): BigNumber$1;
    _spotPriceAfterSwapExactTokenInForTokenOut(poolPairData: Gyro2V2PoolPairData, amount: BigNumber): BigNumber;
    _spotPriceAfterSwapTokenInForExactTokenOut(poolPairData: Gyro2V2PoolPairData, amount: BigNumber): BigNumber;
    _derivativeSpotPriceAfterSwapExactTokenInForTokenOut(poolPairData: Gyro2V2PoolPairData, amount: BigNumber): BigNumber;
    _derivativeSpotPriceAfterSwapTokenInForExactTokenOut(poolPairData: Gyro2V2PoolPairData, amount: BigNumber): BigNumber;
}

declare type Gyro3PoolPairData = PoolPairBase & {
    balanceTertiary: BigNumber$1;
    decimalsTertiary: number;
};
declare type Gyro3PoolToken = Pick<SubgraphToken, 'address' | 'balance' | 'decimals'>;
declare class Gyro3Pool implements PoolBase<Gyro3PoolPairData> {
    poolType: PoolTypes;
    id: string;
    address: string;
    tokensList: string[];
    ...
    getNormalizedLiquidity(poolPairData: Gyro3PoolPairData): BigNumber;
    getLimitAmountSwap(poolPairData: Gyro3PoolPairData, swapType: SwapTypes): BigNumber;
    updateTokenBalanceForPool(token: string, newBalance: BigNumber$1): void;
    updateTotalShares(newTotalShares: BigNumber$1): void;
    _exactTokenInForTokenOut(poolPairData: Gyro3PoolPairData, amount: BigNumber): BigNumber;
    _tokenInForExactTokenOut(poolPairData: Gyro3PoolPairData, amount: BigNumber): BigNumber;
    _calcTokensOutGivenExactBptIn(bptAmountIn: BigNumber$1): BigNumber$1[];
    _calcBptOutGivenExactTokensIn(amountsIn: BigNumber$1[]): BigNumber$1;
    _spotPriceAfterSwapExactTokenInForTokenOut(poolPairData: Gyro3PoolPairData, amount: BigNumber): BigNumber;
    _spotPriceAfterSwapTokenInForExactTokenOut(poolPairData: Gyro3PoolPairData, amount: BigNumber): BigNumber;
    _derivativeSpotPriceAfterSwapExactTokenInForTokenOut(poolPairData: Gyro3PoolPairData, amount: BigNumber): BigNumber;
    _derivativeSpotPriceAfterSwapTokenInForExactTokenOut(poolPairData: Gyro3PoolPairData, amount: BigNumber): BigNumber;
}
...
declare type GyroEPoolPairData = PoolPairBase & {
    tokenInIsToken0: boolean;
};
declare type GyroEPoolToken = Pick<SubgraphToken, 'address' | 'balance' | 'decimals'>;
declare type GyroEParamsFromSubgraph = {
    alpha: string;
    beta: string;
    c: string;
    s: string;
...
declare type DerivedGyroEParamsFromSubgraph = {
    tauAlphaX: string;
    tauAlphaY: string;
    tauBetaX: string;
    tauBetaY: string;
...
declare class GyroEV2Pool implements PoolBase<GyroEPoolPairData> {
    poolType: PoolTypes;
    id: string;
    address: string;
    tokensList: string[];
    ...
    constructor(id: string, address: string, swapFee: string, totalShares: string, tokens: GyroEPoolToken[], tokensList: string[], gyroEParams: GyroEParamsFromSubgraph, derivedGyroEParams: DerivedGyroEParamsFromSubgraph, tokenRates: string[]);
    parsePoolPairData(tokenIn: string, tokenOut: string): GyroEPoolPairData;
    getNormalizedLiquidity(poolPairData: GyroEPoolPairData): BigNumber;
    getLimitAmountSwap(poolPairData: GyroEPoolPairData, swapType: SwapTypes): BigNumber;
    updateTokenBalanceForPool(token: string, newBalance: BigNumber$1): void;
    updateTotalShares(newTotalShares: BigNumber$1): void;
    _exactTokenInForTokenOut(poolPairData: GyroEPoolPairData, amount: BigNumber): BigNumber;
    _tokenInForExactTokenOut(poolPairData: GyroEPoolPairData, amount: BigNumber): BigNumber;
    _calcTokensOutGivenExactBptIn(bptAmountIn: BigNumber$1): BigNumber$1[];
    _calcBptOutGivenExactTokensIn(amountsIn: BigNumber$1[]): BigNumber$1;
    _spotPriceAfterSwapExactTokenInForTokenOut(poolPairData: GyroEPoolPairData, amount: BigNumber): BigNumber;
    _spotPriceAfterSwapTokenInForExactTokenOut(poolPairData: GyroEPoolPairData, amount: BigNumber): BigNumber;
    _derivativeSpotPriceAfterSwapExactTokenInForTokenOut(poolPairData: GyroEPoolPairData, amount: BigNumber): BigNumber;
    _derivativeSpotPriceAfterSwapTokenInForExactTokenOut(poolPairData: GyroEPoolPairData, amount: BigNumber): BigNumber;
}

declare type FxPoolToken = Pick<SubgraphToken, 'address' | 'balance' | 'decimals' | 'token'>;
declare type FxPoolPairData = PoolPairBase & {
    alpha: BigNumber;
    beta: BigNumber;
    lambda: BigNumber;
    delta: BigNumber;
    epsilon: BigNumber;
    tokenInLatestFXPrice: BigNumber$1;
    tokenInfxOracleDecimals: number;
    tokenOutLatestFXPrice: BigNumber$1;
    tokenOutfxOracleDecimals: number;
};
declare class FxPool implements PoolBase<FxPoolPairData> {
    poolType: PoolTypes;
    id: string;
    address: string;
    swapFee: BigNumber$1;
    ...
    getNormalizedLiquidity(poolPairData: FxPoolPairData): BigNumber;
    getLimitAmountSwap(poolPairData: FxPoolPairData, swapType: SwapTypes): BigNumber;
    _getLimitAmountSwap(poolPairData: FxPoolPairData, swapType: SwapTypes): BigNumber;
    updateTokenBalanceForPool(token: string, newBalance: BigNumber$1): void;
    _exactTokenInForTokenOut(poolPairData: FxPoolPairData, amount: BigNumber): BigNumber;
    _tokenInForExactTokenOut(poolPairData: FxPoolPairData, amount: BigNumber): BigNumber;
    _spotPriceAfterSwapExactTokenInForTokenOut(poolPairData: FxPoolPairData, amount: BigNumber): BigNumber;
    _spotPriceAfterSwapTokenInForExactTokenOut(poolPairData: FxPoolPairData, amount: BigNumber): BigNumber;
    _derivativeSpotPriceAfterSwapExactTokenInForTokenOut(poolPairData: FxPoolPairData, amount: BigNumber): BigNumber;
    _derivativeSpotPriceAfterSwapTokenInForExactTokenOut(poolPairData: FxPoolPairData, amount: BigNumber): BigNumber;
    /**
     ...
     * @returns
     */
    _inHigherPrecision(funcName: Function, ...args: any[]): BigNumber;
}
...
declare function _spotPriceAfterSwapExactTokenInForTokenOut$3(amount: BigNumber, poolPairData: WeightedPoolPairData): BigNumber;
declare function _spotPriceAfterSwapTokenInForExactTokenOut$3(amount: BigNumber, poolPairData: WeightedPoolPairData): BigNumber;
...
declare function _derivativeSpotPriceAfterSwapExactTokenInForTokenOut$4(amount: BigNumber, poolPairData: WeightedPoolPairData): BigNumber;
declare function _derivativeSpotPriceAfterSwapTokenInForExactTokenOut$4(amount: BigNumber, poolPairData: WeightedPoolPairData): BigNumber;
...
declare namespace weightedMath {
  export {
    ...
    _spotPriceAfterSwapExactTokenInForTokenOut$3 as _spotPriceAfterSwapExactTokenInForTokenOut,
    _spotPriceAfterSwapTokenInForExactTokenOut$3 as _spotPriceAfterSwapTokenInForExactTokenOut,
    ...
    _derivativeSpotPriceAfterSwapExactTokenInForTokenOut$4 as _derivativeSpotPriceAfterSwapExactTokenInForTokenOut,
    _derivativeSpotPriceAfterSwapTokenInForExactTokenOut$4 as _derivativeSpotPriceAfterSwapTokenInForExactTokenOut,
...
/**********************************************************************************************
    ...
    **********************************************************************************************/
declare function _exactTokenInForTokenOut$1(amount: BigNumber, poolPairData: StablePoolPairData): BigNumber;
/**********************************************************************************************
    ...
    **********************************************************************************************/
declare function _tokenInForExactTokenOut$1(amount: BigNumber, poolPairData: StablePoolPairData): BigNumber;
...
declare function _spotPriceAfterSwapExactTokenInForTokenOut$2(amount: BigNumber, poolPairData: StablePoolPairData): BigNumber;
declare function _spotPriceAfterSwapTokenInForExactTokenOut$2(amount: BigNumber, poolPairData: StablePoolPairData): BigNumber;
declare function _derivativeSpotPriceAfterSwapExactTokenInForTokenOut$3(amount: BigNumber, poolPairData: StablePoolPairData): BigNumber;
declare function _derivativeSpotPriceAfterSwapTokenInForExactTokenOut$3(amount: BigNumber, poolPairData: StablePoolPairData): BigNumber;
...
declare namespace stableMath {
  export {
    ...
    _exactTokenInForTokenOut$1 as _exactTokenInForTokenOut,
    _tokenInForExactTokenOut$1 as _tokenInForExactTokenOut,
...
declare function _spotPriceAfterSwapExactTokenInForTokenOut$1(amp: bigint, balances: bigint[], tokenIndexIn: number, tokenIndexOut: number, amountIn: bigint, fee: bigint): bigint;
declare function _spotPriceAfterSwapTokenInForExactTokenOut$1(amp: bigint, balances: bigint[], tokenIndexIn: number, tokenIndexOut: number, amountOut: bigint, fee: bigint): bigint;
...
declare function _derivativeSpotPriceAfterSwapExactTokenInForTokenOut$2(balances: BigNumber$1[], outAmount: BigNumber$1, virtualParamOut: BigNumber$1): BigNumber$1;
declare function _derivativeSpotPriceAfterSwapTokenInForExactTokenOut$2(balances: BigNumber$1[], inAmount: BigNumber$1, outAmount: BigNumber$1, virtualParamIn: BigNumber$1, virtualParamOut: BigNumber$1, swapFee: BigNumber$1): BigNumber$1;
...
declare function _derivativeSpotPriceAfterSwapExactTokenInForTokenOut$1(balances: BigNumber$1[], outAmount: BigNumber$1, virtualOffsetInOut: BigNumber$1): BigNumber$1;
declare function _derivativeSpotPriceAfterSwapTokenInForExactTokenOut$1(balances: BigNumber$1[], inAmount: BigNumber$1, outAmount: BigNumber$1, virtualOffsetInOut: BigNumber$1, swapFee: BigNumber$1): BigNumber$1;
...
declare const ONE_36: BigNumber$1;
declare const ONE_18: BigNumber$1;
declare const OLD_ONE_36: BigNumber;
declare const CURVEMATH_MAX_DIFF_36: BigNumber$1;
declare const ONE_TO_THE_THIRTEEN_NUM_36: BigNumber$1;
declare enum CurveMathRevert {
...
interface ReservesInNumeraire {
    tokenInReservesInNumeraire_36: BigNumber$1;
    tokenOutReservesInNumeraire_36: BigNumber$1;
    _oGLiq_36: BigNumber$1;
}
declare const poolBalancesToNumeraire: (poolPairData: FxPoolPairData) => ReservesInNumeraire;
/**
 *
 ...
 */
declare const viewRawAmount: (amount_36: BigNumber$1, tokenDecimals: number, rate: BigNumber$1, fxOracleDecimals: number) => BigNumber$1;
/**
 ...
 */
declare const viewNumeraireAmount: (amount_36: BigNumber$1, tokenDecimals: number, rate: BigNumber$1, fxOracleDecimals: number) => BigNumber$1;
declare function _exactTokenInForTokenOut(amount: BigNumber, poolPairData: FxPoolPairData): BigNumber;
declare function _tokenInForExactTokenOut(amount: BigNumber, poolPairData: FxPoolPairData): BigNumber;
declare const spotPriceBeforeSwap: (amount_36: BigNumber$1, poolPairData: FxPoolPairData) => BigNumber;
declare const _spotPriceAfterSwapExactTokenInForTokenOut: (poolPairData: FxPoolPairData, amount: BigNumber) => BigNumber;
declare const _spotPriceAfterSwapTokenInForExactTokenOut: (poolPairData: FxPoolPairData, amount: BigNumber) => BigNumber;
declare const _derivativeSpotPriceAfterSwapExactTokenInForTokenOut: (amount: BigNumber, poolPairData: FxPoolPairData) => BigNumber;
declare const _derivativeSpotPriceAfterSwapTokenInForExactTokenOut: (amount: BigNumber, poolPairData: FxPoolPairData) => BigNumber;

declare const fxPoolMath_ONE_36: typeof ONE_36;
declare const fxPoolMath_ONE_18: typeof ONE_18;
declare const fxPoolMath_OLD_ONE_36: typeof OLD_ONE_36;
declare const fxPoolMath_CURVEMATH_MAX_DIFF_36: typeof CURVEMATH_MAX_DIFF_36;
declare const fxPoolMath_ONE_TO_THE_THIRTEEN_NUM_36: typeof ONE_TO_THE_THIRTEEN_NUM_36;
type fxPoolMath_CurveMathRevert = CurveMathRevert;
declare const fxPoolMath_CurveMathRevert: typeof CurveMathRevert;
declare const fxPoolMath_poolBalancesToNumeraire: typeof poolBalancesToNumeraire;
declare const fxPoolMath_viewRawAmount: typeof viewRawAmount;
declare const fxPoolMath_viewNumeraireAmount: typeof viewNumeraireAmount;
declare const fxPoolMath__exactTokenInForTokenOut: typeof _exactTokenInForTokenOut;
declare const fxPoolMath__tokenInForExactTokenOut: typeof _tokenInForExactTokenOut;
declare const fxPoolMath_spotPriceBeforeSwap: typeof spotPriceBeforeSwap;
declare const fxPoolMath__spotPriceAfterSwapExactTokenInForTokenOut: typeof _spotPriceAfterSwapExactTokenInForTokenOut;
declare const fxPoolMath__spotPriceAfterSwapTokenInForExactTokenOut: typeof _spotPriceAfterSwapTokenInForExactTokenOut;
declare const fxPoolMath__derivativeSpotPriceAfterSwapExactTokenInForTokenOut: typeof _derivativeSpotPriceAfterSwapExactTokenInForTokenOut;
declare const fxPoolMath__derivativeSpotPriceAfterSwapTokenInForExactTokenOut: typeof _derivativeSpotPriceAfterSwapTokenInForExactTokenOut;
declare namespace fxPoolMath {
  export {
    fxPoolMath_ONE_36 as ONE_36,
    fxPoolMath_ONE_18 as ONE_18,
    fxPoolMath_OLD_ONE_36 as OLD_ONE_36,
    fxPoolMath_CURVEMATH_MAX_DIFF_36 as CURVEMATH_MAX_DIFF_36,
    fxPoolMath_ONE_TO_THE_THIRTEEN_NUM_36 as ONE_TO_THE_THIRTEEN_NUM_36,
    fxPoolMath_CurveMathRevert as CurveMathRevert,
    fxPoolMath_poolBalancesToNumeraire as poolBalancesToNumeraire,
    fxPoolMath_viewRawAmount as viewRawAmount,
    fxPoolMath_viewNumeraireAmount as viewNumeraireAmount,
    fxPoolMath__exactTokenInForTokenOut as _exactTokenInForTokenOut,
    fxPoolMath__tokenInForExactTokenOut as _tokenInForExactTokenOut,
    fxPoolMath_spotPriceBeforeSwap as spotPriceBeforeSwap,
    fxPoolMath__spotPriceAfterSwapExactTokenInForTokenOut as _spotPriceAfterSwapExactTokenInForTokenOut,
    fxPoolMath__spotPriceAfterSwapTokenInForExactTokenOut as _spotPriceAfterSwapTokenInForExactTokenOut,
    fxPoolMath__derivativeSpotPriceAfterSwapExactTokenInForTokenOut as _derivativeSpotPriceAfterSwapExactTokenInForTokenOut,
    fxPoolMath__derivativeSpotPriceAfterSwapTokenInForExactTokenOut as _derivativeSpotPriceAfterSwapTokenInForExactTokenOut,
  };
}

declare function calcSpotPriceYGivenX(x: BigNumber$1, params: GyroEParams, d: DerivedGyroEParams, r: Vector2): BigNumber$1;
declare function calcSpotPriceXGivenY(y: BigNumber$1, params: GyroEParams, d: DerivedGyroEParams, r: Vector2): BigNumber$1;
declare function normalizedLiquidityYIn(balances: BigNumber$1[], params: GyroEParams, derived: DerivedGyroEParams, fee: BigNumber$1, rVec: Vector2): BigNumber$1;
declare function normalizedLiquidityXIn(balances: BigNumber$1[], params: GyroEParams, derived: DerivedGyroEParams, fee: BigNumber$1, rVec: Vector2): BigNumber$1;
declare function dPyDXIn(balances: BigNumber$1[], params: GyroEParams, derived: DerivedGyroEParams, fee: BigNumber$1, rVec: Vector2): BigNumber$1;
declare function dPxDYIn(balances: BigNumber$1[], params: GyroEParams, derived: DerivedGyroEParams, fee: BigNumber$1, rVec: Vector2): BigNumber$1;
declare function dPxDXOut(balances: BigNumber$1[], params: GyroEParams, derived: DerivedGyroEParams, fee: BigNumber$1, rVec: Vector2): BigNumber$1;
declare function dPyDYOut(balances: BigNumber$1[], params: GyroEParams, derived: DerivedGyroEParams, fee: BigNumber$1, rVec: Vector2): BigNumber$1;

declare const gyroEMathFunctions_calcSpotPriceYGivenX: typeof calcSpotPriceYGivenX;
declare const gyroEMathFunctions_calcSpotPriceXGivenY: typeof calcSpotPriceXGivenY;
declare const gyroEMathFunctions_normalizedLiquidityYIn: typeof normalizedLiquidityYIn;
declare const gyroEMathFunctions_normalizedLiquidityXIn: typeof normalizedLiquidityXIn;
declare const gyroEMathFunctions_dPyDXIn: typeof dPyDXIn;
declare const gyroEMathFunctions_dPxDYIn: typeof dPxDYIn;
declare const gyroEMathFunctions_dPxDXOut: typeof dPxDXOut;
declare const gyroEMathFunctions_dPyDYOut: typeof dPyDYOut;
declare namespace gyroEMathFunctions {
  export {
    gyroEMathFunctions_calcSpotPriceYGivenX as calcSpotPriceYGivenX,
    gyroEMathFunctions_calcSpotPriceXGivenY as calcSpotPriceXGivenY,
    gyroEMathFunctions_normalizedLiquidityYIn as normalizedLiquidityYIn,
    gyroEMathFunctions_normalizedLiquidityXIn as normalizedLiquidityXIn,
    gyroEMathFunctions_dPyDXIn as dPyDXIn,
    gyroEMathFunctions_dPxDYIn as dPxDYIn,
    gyroEMathFunctions_dPxDXOut as dPxDXOut,
    gyroEMathFunctions_dPyDYOut as dPyDYOut,
  };
}

declare function mulUp(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function divUp(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function mulDown(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function divDown(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function mulXpU(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function divXpU(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function mulDownMagU(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function divDownMagU(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function mulUpMagU(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function divUpMagU(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function mulUpXpToNpU(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function mulDownXpToNpU(a: BigNumber$1, b: BigNumber$1): BigNumber$1;
declare function sqrt(input: BigNumber$1, tolerance: BigNumber$1): BigNumber$1;

declare const gyroSignedFixedPoint_mulUp: typeof mulUp;
declare const gyroSignedFixedPoint_divUp: typeof divUp;
declare const gyroSignedFixedPoint_mulDown: typeof mulDown;
declare const gyroSignedFixedPoint_divDown: typeof divDown;
declare const gyroSignedFixedPoint_mulXpU: typeof mulXpU;
declare const gyroSignedFixedPoint_divXpU: typeof divXpU;
declare const gyroSignedFixedPoint_mulDownMagU: typeof mulDownMagU;
declare const gyroSignedFixedPoint_divDownMagU: typeof divDownMagU;
declare const gyroSignedFixedPoint_mulUpMagU: typeof mulUpMagU;
declare const gyroSignedFixedPoint_divUpMagU: typeof divUpMagU;
declare const gyroSignedFixedPoint_mulUpXpToNpU: typeof mulUpXpToNpU;
declare const gyroSignedFixedPoint_mulDownXpToNpU: typeof mulDownXpToNpU;
declare const gyroSignedFixedPoint_sqrt: typeof sqrt;
declare namespace gyroSignedFixedPoint {
  export {
    gyroSignedFixedPoint_mulUp as mulUp,
    gyroSignedFixedPoint_divUp as divUp,
    gyroSignedFixedPoint_mulDown as mulDown,
    gyroSignedFixedPoint_divDown as divDown,
    gyroSignedFixedPoint_mulXpU as mulXpU,
    gyroSignedFixedPoint_divXpU as divXpU,
    gyroSignedFixedPoint_mulDownMagU as mulDownMagU,
    gyroSignedFixedPoint_divDownMagU as divDownMagU,
    gyroSignedFixedPoint_mulUpMagU as mulUpMagU,
    gyroSignedFixedPoint_divUpMagU as divUpMagU,
    gyroSignedFixedPoint_mulUpXpToNpU as mulUpXpToNpU,
    gyroSignedFixedPoint_mulDownXpToNpU as mulDownXpToNpU,
    gyroSignedFixedPoint_sqrt as sqrt,
  };
}

declare function _normalizeBalances(balances: BigNumber$1[], decimals: number[]): BigNumber$1[];
declare function _reduceFee(amountIn: BigNumber$1, swapFee: BigNumber$1): BigNumber$1;
declare function _addFee(amountIn: BigNumber$1, swapFee: BigNumber$1): BigNumber$1;

declare const helpers__normalizeBalances: typeof _normalizeBalances;
declare const helpers__reduceFee: typeof _reduceFee;
declare const helpers__addFee: typeof _addFee;
declare namespace helpers {
  export {
    helpers__normalizeBalances as _normalizeBalances,
    helpers__reduceFee as _reduceFee,
    helpers__addFee as _addFee,
  };
}
